...
- **PeriodFilter** — props: startDate, endDate, granularity, basePath — `src/app/(app)/analytics/components/period-filter.tsx`
...
- **FinancialReportTable** — props: rows — `src/app/(app)/analytics/report/components/financial-report-table.tsx`
- **CategoryForm** — props: category, categories — `src/app/(app)/categories/components/category-form.tsx`
- **RuleForm** — props: rule, categories, triggerLabel — `src/app/(app)/classification-rules/components/rule-form.tsx`
- **RulesTable** — props: rules, categories — `src/app/(app)/classification-rules/components/rules-table.tsx`
...
- **ImportWizard** — props: accounts, categories, initialRules — `src/app/(app)/transactions/import/components/import-wizard.tsx`
- **ReviewClient** — props: initialRows, categories, accounts, rules — `src/app/(app)/transactions/review/components/review-client.tsx`
...
- **ClassificationTable** — props: rows, categories, onChange, onCreateRule — `src/components/transactions/classification-table.tsx`
